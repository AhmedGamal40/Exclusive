          ...
          <div className="lg:col-span-2 max-lg:order-1 p-6 max-w-4xl mx-auto w-full">
            ...
            <form className="lg:mt-12">
              ...
              <div className="mt-12">
                ...
                <div className="grid gap-6 mt-8">
                  ...
                  <div className="flex items-center me-4">
                    ...
                    <label for="red-checkbox" className="ml-3 block text-sm">
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                <button type="button" className="min-w-[150px] px-6 py-3.5 text-sm bg-red-500 text-white rounded-md ">Confirm payment</button>
              </div>
            </form>
          </div>
                ...
                <div className="space-y-6 mt-10">
                  <div className="grid sm:grid-cols-2 items-start gap-6">
                    <div className="max-w-[190px] px-4 py-6 shrink-0 bg-gray-200 rounded-md">
                      <img src='https://readymadeui.com/images/product10.webp' className="w-full object-contain" alt='dqwd'/>
                    </div>
                    <div>
                  ...
                  <div className="grid sm:grid-cols-2 items-start gap-6">
                    <div className="max-w-[190px] px-4 py-6 shrink-0 bg-gray-200 rounded-md">
                      <img src='https://readymadeui.com/images/product14.webp' className="w-full object-contain" alt='fefe'/>
                    </div>
                    <div>
